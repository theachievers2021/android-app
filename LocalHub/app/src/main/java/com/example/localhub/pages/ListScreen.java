...
import com.example.localhub.domain.LocationInfo;
import com.example.localhub.domain.LocationInfoModel;
    ...
    private void getLocationInfo(String id) {
        ...
        call.enqueue(new Callback<JsonObject>() {
            ...
            public void onResponse(Call<JsonObject> call, Response<JsonObject> response) {
                ...
                List<LocationInfo> alLocations=new ArrayList<>();
                JsonObject responseData = (JsonObject) data.get("response");
//                int nr = responseData.getAsJsonArray("docs").size();
////                Gson gson=new Gson();
////                LocationInfoModel locationInfoModel=gson.fromJson(responseData,LocationInfoModel.class);
////                int i=0;
////                for(LocationInfo locationInfo:locationInfoModel.info){
////                    alLocations.add(locationInfo);
////                    i++;
////                }
//               //JsonObject locationData = (JsonObject) responseData.getAsJsonArray("docs").get(0);
